...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var mobileToggle = document.querySelector('.site-actions__mobile-menu');
  var mobileMenuClose = document.querySelector('.site-navigation__close');
  var mobileMenubackdrop = document.createElement('div');
...
//Theme Switch
(function () {
  var themeSwitch = document.querySelector('.site-actions__theme-toggle');
  themeSwitch.addEventListener('click', function () {
    var rootElement = document.documentElement;
    var currentTheme = rootElement.getAttribute('data-theme-mode');
...
// Accordion List
(function () {
  document.querySelectorAll('.accordion-card').forEach(function (accordion) {
    var heading = accordion.querySelector('.accordion-card__title');
